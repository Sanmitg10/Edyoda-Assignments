...
def edit_ans(di,sub,level,ques):
...
def Admin(di):
    ...
    while T:
        ...
        if(n==1):
            ...
            if(s==1):
                edit_ques(di,sub,level,ques)
            elif(s==2):
                edit_opt(di,sub,level,ques)
            elif(s==3):
                edit_ans(di,sub,level,ques)
